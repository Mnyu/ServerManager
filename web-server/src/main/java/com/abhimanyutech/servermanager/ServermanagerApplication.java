...
//							.imageUrl("http://localhost:8080/server/image/server.png")
...
//	}
	...
	public CorsFilter corsFilter() {
		...
		corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:4200", "http://mk:4200"));
